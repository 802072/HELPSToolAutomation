...
public class DropdownTest extends BaseTestDD {
	...
	// Select: Select an option
	@Test(groups = "UAS Assessment Details: Psychiatric Depression: Psychiatric Depression")
	...
	// Select: Independent - no physical assistance, setup, or supervision in any episode
	@Test(groups = "IADL - Capacity: Meal Preparation")
	...
	// Select: Limited assistance - guided maneuvering of limbs, physical guidance without taking weight
	@Test(groups = "IADL - Capacity: Meal Preparation")
	...
	// Select: Select: Total dependence - full performance by others during all episodes
	@Test(groups = "IADL - Capacity: Meal Preparation")
	...
	//Select: Extensive assistance - weight-bearing support (including lifting limbs) by 1 helper where person still performs 50% or more of subtasks
	@Test(groups = "IADL - Capacity: Shopping Response")
	...
	//Select: Maximal assistance - weight-bearing support (including lifting limbs) by 2+ helpers - OR - weight-bearing support for more than 50% of subtasks
	@Test(groups = "IADL - Capacity: Shopping Response")
	...
	//Select: Independent, setup help only - article or device provided or placed within reach, no physical assistance or supervision in any episode
	@Test(groups = "ADL - Self Performance: Bathing Response")
	...
	//Independent, setup help only - article or device provided or placed within reach, no physical assistance or supervision in any episode
	@Test(groups = "ADL - Self Performance: Personal Hygiene")
	...
	//Limited assistance - guided maneuvering of limbs, physical guidance without taking weight
	@Test(groups = "ADL - Self Performance: Personal Hygiene")
	...
	//Extensive assistance - weight-bearing support (including lifting limbs) by 1 helper where person still performs 50% or more of subtasks
	@Test(groups = "ADL - Self Performance: Personal Hygiene")
	...
	// Maximal assistance - weight-bearing support (including lifting limbs) by 2+ helpers - OR - weight-bearing support for more than 50% of subtasks
	@Test(groups = "ADL - Self Performance: Personal Hygiene")
	...
	//Select: Extensive assistance - weight-bearing support (including lifting limbs) by 1 helper where person still performs 60% or more of subtasks
	@Test(groups = "ADL - Self Performance: Transfer Toilet")
	...
	//Select:Maximal assistance - weight-bearing support (including lifting limbs) by 2+ helpers - OR - weight-bearing support for more than 60% of subtasks
	@Test(groups = "ADL - Self Performance: Transfer Toilet")
	...
	//Select: Extensive assistance - weight-bearing support (including lifting limbs) by 1 helper where person still performs 70% or more of subtasks
	@Test(groups = "ADL - Self Performance: Toileting")
	...
	//Select:Maximal assistance - weight-bearing support (including lifting limbs) by 2+ helpers - OR - weight-bearing support for more than 70% of subtasks
	@Test(groups = "ADL - Self Performance: Toileting")
	...
	//Select: Extensive assistance - weight-bearing support (including lifting limbs) by 1 helper where person still performs 80% or more of subtasks
	@Test(groups = "ADL - Self Performance: Bed Mobility")
	...
	//Select:Maximal assistance - weight-bearing support (including lifting limbs) by 2+ helpers - OR - weight-bearing support for more than 80% of subtasks
	@Test(groups = "ADL - Self Performance: Bed Mobility")
	...
	//Select: Extensive assistance - weight-bearing support (including lifting limbs) by 1 helper where person still performs 90% or more of subtasks
	@Test(groups = "ADL - Self Performance: Eating")
	...
	//Select:Maximal assistance - weight-bearing support (including lifting limbs) by 2+ helpers - OR - weight-bearing support for more than 90% of subtasks
	@Test(groups = "ADL - Self Performance: Eating")
