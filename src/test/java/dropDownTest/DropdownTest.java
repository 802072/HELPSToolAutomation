...
public class DropdownTest extends BaseTestDD {
	...
	//Option4: Absent at rest, but present when performed normal day-to-day activities
	@Test(groups = "UAS Assessment Details: Dyspnea")
	...
	//Option3: Minimal - Diminished energy but completes normal day-to-day activities
	@Test(groups = "UAS Assessment Details: Fatigue")
	...
	//Option4: Controlled when therapeutic regimen followed, but not always followed
	// as ordered
	@Test(groups = "UAS Assessment Details: Pain")
	...
	//option2: //Option2: Independent - no physical assistance, setup, or supervision in any episode
	@Test(groups = "IADL - Capacity: Meal Preparation")
	...
	//Option6: Extensive assistance - help throughout task, but performs 50% or more
	// of task on own
	@Test(groups = "IADL - Capacity: Meal Preparation")
	...
	//Option7: Maximal assistance - help throughout task, but performs less than 50%
	// of task on own
	@Test(groups = "IADL - Capacity: Meal Preparation")
	...
	//Option8: //Option8: Total dependence - full performance by others during all episodes
	@Test(groups = "IADL - Capacity: Ordinary Housework Response")
	...
	//Option2: Independent - no physical assistance, setup, or supervision in any episode
	@Test(groups = "IADL - Capacity: Shopping Response")
	...
	//Option3: Independent, setup help only - article or device provided or placed within
	...
	//Option5: Limited assistance - guided maneuvering of limbs, physical guidance without
	// taking weight
	@Test(groups = "ADL - Self Performance: Personal Hygiene")
	...
	//option6: Extensive assistance - weight-bearing support (including lifting limbs) by 1
	...
	//Option7: //Option7: Maximal assistance - weight-bearing support (including lifting limbs) by 2+
	...
	//Option7: Maximal assistance - weight-bearing support (including lifting limbs) by 2+
	// helpers - OR - weight-bearing support for more than 50% of subtasks
	@Test(groups = "ADL - Self Performance: Dressing Upper Body")
